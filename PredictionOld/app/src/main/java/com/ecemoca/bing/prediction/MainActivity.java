...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String INPUT_NAME = "conv2d_1_input_2"; //conv2d_1
    private static final String OUTPUT_NAME = "activation_6_2/Softmax";
    private static final String MODEL_FILE = "file:///android_asset/tf_model.pb";
    private static final String LABEL_FILE = "file:///android_asset/user_label.txt";
